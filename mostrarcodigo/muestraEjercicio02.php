...
<html>
    ...
    <body>
        <header class="text-center bg-secondary text-white">
            <h3>1. Desarrollo de un control de acceso con identificación del usuario basado en la función header() y en el uso de una tabla “Usuario” de la base de datos. (PDO).</h3>
        </header>
